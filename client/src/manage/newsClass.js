...
String.prototype.formatDate = function (r) {
    ...
    r = r.replace('MM', date.getMonth() + 1);
    r = r.replace('dd', date.getDate());
    r = r.replace('hh', date.getHours());
    r = r.replace('mm', date.getMinutes());
    r = r.replace('ss', date.getSeconds());
    r = r.replace('ms', date.getMilliseconds());
    return r;
}
